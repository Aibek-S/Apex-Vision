...
const faqData: FAQItem[] = [
    {
        ...
        answer:
            "После регистрации перейдите в раздел «Главная» и нажмите кнопку «Создать артефакт». Введите название вашего объекта и начните процесс оцифровки. Вы можете загружать фотографии вручную или подключить устройство для автоматической съёмки.",
    ...
    },
    {
        ...
        answer:
            "Платформа поддерживает два режима: Manual Upload — для загрузки фотографий с компьютера, и Device Capture (ESP) — для автоматической съёмки с подключённого устройства. Выберите подходящий режим при создании сессии захвата.",
    ...
    },
    {
        ...
        answer:
            "Каждая фотография должна быть в формате .jpg, .png или .webp и не превышать 10 МБ. Вы можете загружать любое количество изображений для одного артефакта. Для лучшего результата рекомендуется минимум 20-30 фотографий с разных ракурсов.",
    ...
    },
    {
        ...
        answer:
            "«Создан» — артефакт только что добавлен; «В обработке» — идёт анализ и построение модели; «Готов» — модель успешно создана и доступна для просмотра; «Ошибка» — возникла проблема при обработке, проверьте качество фотографий.",
    ...
    },
    {
        ...
        answer:
            "Откройте страницу вашего артефакта со статусом «Готов», найдите переключатель «Публиковать в галерее» и активируйте его. Ваша работа появится в публичной галерее, где её смогут увидеть другие пользователи. Вы можете в любой момент снять публикацию.",
    ...
    },
    {
        ...
        answer:
            "Убедитесь, что вы используете правильный email и пароль. Если забыли пароль, используйте функцию восстановления на странице входа. Проверьте, что ваш email подтверждён (письмо приходит при регистрации). Если проблема сохраняется, обратитесь в поддержку.",
                ...
                <div className="space-y-6">
                    ...
                    <div className="rounded-2xl border border-white/60 bg-white/70 p-6 shadow-sm space-y-4">
                        ...
                        <p className="text-sm text-secondary">
                            Не нашли ответ на свой вопрос? Наша команда всегда готова
                            помочь.
                        </p>
                        <Button
                            variant="primary"
                    ...
                    <div className="rounded-2xl border border-secondary/20 bg-secondary/5 p-6 shadow-sm space-y-3">
                        ...
                        <p className="text-sm text-secondary">
                            Полная техническая документация и руководства по настройке
                            доступны в README файле проекта.
                        </p>
                        <Button
                            variant="outline"
                            size="sm"
